...
export const BOARD_TEMPLATES = [
  ...
  {
    id: "devoluciones-reacondicionado-tarimas",
    name: "Devoluciones / Reacondicionado por tarima",
    description: "Flujo de escaneo continuo por tarima con control de lotes, caducidad y piezas por producto.",
    settings: {
      showWorkflow: true,
      showMetrics: true,
      showAssignee: true,
    ...
    columns: [
      { label: "Tarima", type: "text", required: true, width: "sm", groupName: "Control", groupColor: "#ede9fe", helpText: "Número único de tarima." },
      { label: "Tipo de flujo", type: "select", optionSource: "manual", options: ["Devolución", "Reacondicionado"], required: true, width: "sm", groupName: "Control", groupColor: "#ede9fe", helpText: "Clasifica la tarima." },
      { label: "Producto", type: "inventoryLookup", required: true, width: "md", groupName: "Producto", groupColor: "#e0f2fe", helpText: "Producto detectado por escáner." },
      { label: "Lote", type: "text", required: true, width: "sm", groupName: "Lote", groupColor: "#dcfce7", helpText: "Lote capturado para ese producto." },
      { label: "Caducidad", type: "text", required: true, width: "sm", groupName: "Lote", groupColor: "#dcfce7", helpText: "Caducidad del lote capturado (texto en mayúsculas)." },
      { label: "Piezas", type: "number", defaultValue: 1, required: true, width: "sm", groupName: "Cantidad", groupColor: "#fef3c7", helpText: "Piezas agregadas para ese lote." },
      { label: "Meta de caja", type: "number", defaultValue: 50, width: "sm", groupName: "Cantidad", groupColor: "#fef3c7", helpText: "Objetivo total de piezas para cierre automático de la caja." },
    ],
  },
  {
    id: "auditoria",
